...
namespace Infrastructure
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser, IdentityRole<Guid>, Guid>
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            // Identity table names and keys are already configured by IdentityDbContext
            ...
            builder.Entity<PurchaseItem>().Property(pi => pi.UnitCost).HasColumnType("decimal(18,2)");
            ...
            // Further seeding (like admin user) should be done in a secure manner (e.g., env password hash) and is omitted here.

            // Additional configuration hints:
            // - Use AsNoTracking() in repository read methods for performance
            // - Use transactions for multi-entity updates (e.g., Purchase creation + Product updates)
        }
    }
}
